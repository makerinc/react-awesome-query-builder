...
var TARGETING = {
  page: ["dimension_url", "dimension_query_param", "dimension_path", "dimension_host", "dimension_fragment"]
};
...
var Field = (_temp = _class = function (_Component) {
  ...
  function Field(props) {
    ...
    _this.handleFieldMenuSelect = function (_ref) {
      var key = _ref.key,
    ...
    value: function buildSelectItems(fields) {
      ...
      if (filterByTargeting && TARGETING[filterByTargeting]) {
        fieldKeys = fieldKeys.filter(function (fieldKey) {
          return TARGETING[filterByTargeting].indexOf(fieldKey) > -1;
        });
      }
