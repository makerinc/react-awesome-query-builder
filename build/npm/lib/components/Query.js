...
var devToolsExtension = window.__REDUX_DEVTOOLS_EXTENSION__ || window.devToolsExtension;
...
var Query = (_temp2 = _class2 = function (_Component2) {
  ...
  function Query(props, context) {
    ...
    _this2.state = {
      store: (0, _redux.createStore)(store, undefined, (0, _redux.compose)(devToolsExtension ? devToolsExtension({
